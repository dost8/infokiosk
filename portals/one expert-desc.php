...
<div class="" style="background:white;height:100%;border-radius:5px;font-family:roboto;">
   <a href="#" style="position:absolute;" onclick="openModalLink('https://oneexpert.gov.ph/visitors/login_required','One Expert')">
 ...
 <h1 style="text-align:center;margin-top:0px">OneExpert</h1>
   <div class="col-lg-12 container">
    <section class="row 1st">
      <div class=""  style="color:#555;text-align:justify;width:96%;margin-left:10px;">
        <p>OneExpert is an interactive web-based nationwide pool of S&T experts intended to provide advise and consultancy services to Filipinos anywhere they are in the Philippines.</p>
        <p>OneExpert is intenteded to improve access to experts and technologies particularly by people living outside of the major urban centers where most research and technical institutions are located. In the same manner, OneExpert will likewise brin services of any accredited expert located anywhere in the Philippines to clients that need S&T assistance.</p>
      </div>
    </section>
    ...
    <section class="row 3rd" style="width:101%;">
      <div style="color:#555">
        ...
        <ul style="list-style-type:none;margin-left:-10px;text-indent:5px;text-indent:-9px;">
          ...
          <li><i class="fa fa-check" style="color:green"></i>&nbsp;Information about various DOST Consultancy Prorams.</li>
          <li><i class="fa fa-check" style="color:green"></i>&nbsp;Forum where users can post questions and/or answers to existing threads, organized under specific categories.</li>
        </ul>
      </div>
    </section>
  </div>
